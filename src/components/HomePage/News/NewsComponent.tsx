  ...
  const posts = [
    {
      ...
      title:
        'The second stage of the national series "X-TEAM Time Attack 2021" took place',
    ...
    <div>
      ...
      >
        {posts.map((item, index) => {
          return (
            <div className={clsx(classes.newsWrapper, classes.flexCenter)}>
