...
const NotificationDropDown = (props:{notifDropDownRef:any, anchorEl:any,handleCloseMenu:any})=>{
  ...
  return(
    <>
      <Menu ref={props.notifDropDownRef} 
       ...
       {/* <ArrowDropUp className={clsx(classes.userBarComponentW, classes.userBarNotifArrow)} fontSize='large'/>       */}
        <MenuList className={classes.userBarNotifDropdown}>
          <div className={classes.notifHeader}>
            ...
            <div className={classes.notifHText}><span>Mark all as read</span></div>
          </div>
